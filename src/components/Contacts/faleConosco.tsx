...
const FaleConosco: React.FC<ContatoProps> = ({ isExpanded }) => {
  return (
    <div className="w-[80vw] mx-auto ">
      <h3 className="text-center text-lg md:text-2xl font-bold pt-5 mb-3">Fale Conosco</h3>
        <div className="md:flex overflow-hidden rounded-lg shadow-lg content">
          <p className="ml-5 mb-5 md:items-center content-center">
          ...
          <iframe className="w-[50vw] mx-auto h-[30vh] md:h-[60vh] md:w-[50vw]"
